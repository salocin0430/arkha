...
export default function Signup() {
  ...
  if (signupSuccess) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0042A6] to-[#07173F] text-white">
        {/* Background Glow Effect */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <div className="w-[600px] h-[600px] bg-[#0042A6]/30 rounded-full blur-[150px]" />
        </div>
        ...
        <div className="flex items-center justify-center min-h-screen p-4 relative pt-32">
          <div className="w-full max-w-sm p-8 space-y-8 z-10 text-center">
            <div className="w-20 h-20 mx-auto mb-6 bg-[#EAFE07] rounded-full flex items-center justify-center">
              <svg className="w-10 h-10 text-[#07173F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="w-full max-w-sm p-6 space-y-6 z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#EAFE07] text-[#07173F] py-3 rounded-lg font-semibold hover:bg-[#EAFE07]/80 transition-colors disabled:opacity-50 text-base"
            >
